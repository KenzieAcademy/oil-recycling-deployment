...
docker run -e MONGO_HOST=$MONGO_HOST -e SUPER_USER_EMAIL=$SUPER_USER_EMAIL -e SUPER_USER_PASSWORD=$SUPER_USER_PASSWORD --name oil-recycling-node -p 80:8080 -d kenzieacademy/oil-recycling-node:$TAG
